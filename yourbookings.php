...
<head>
    ...
    img {
     ...
     function pageRedirect() {
      window.location.href = "../Bike Showroom/invoicepdf.php";
    } 
  </script>
</head>
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          echo "<tr>
            ...
            <td> <button class='generate btn btn-sm btn-primary' id=d" . $row['booking_id'] . ">Generate Receipt</button>  </td>
          </tr>";
        }
        // header("Location:invoicepdf.php");
        // <form action='invoicepdf.php' target='_blank'> </form>
        ?>
      </tbody>
    </table>
    <a href="welcome_cust.php" class="btn btn-primary" style="background: var(--bs-orange);">Back</a>
